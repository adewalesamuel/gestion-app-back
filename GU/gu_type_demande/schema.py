...
class GUTypeDemandeSchema(SQLAlchemySchema):
    ...
    delai_traitement_jours = auto_field(validate=validate.Length(min=1))
    cout = auto_field(validate=validate.Length(min=1))
    validite_mois = auto_field(validate=validate.Length(min=1))
