...
from marshmallow import Schema, fields, validate, validates_schema, ValidationError, EXCLUDE, post_load
...
class UserSchema(SQLAlchemySchema):
    ...
    profil_img_url = auto_field(validate=validate.Length(min=1))
    ...
    last_login_date = auto_field()
    last_login_heure = auto_field()
